...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div>
                <asp:CustomValidator ID="cvCurp" runat="server" ErrorMessage="La CURP no coincide con la fecha de nacimiento" ControlToValidate="tbxCurp" CssClass="text-danger" ClientValidationFunction="curpDate"></asp:CustomValidator>
            </div>
        </div>
        <div class="form-group">
    ...
    <script>
        function curpDate(source, arguments) {
            var fechaFecha = $("#<%=tbxFecha.ClientID%>").val()
            var fechaCurp = arguments.Value

            var fecha1 = fechaFecha.substring(2, 4) + fechaFecha.substring(5, 7) + fechaFecha.substring(8, 10)
            var fecha2 = fechaCurp.substring(4, 10)

            if (fecha1 == fecha2) arguments.IsValid = true
